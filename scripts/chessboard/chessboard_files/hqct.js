...
var PVer='110717';
var MNot;
var bch='\u8F66\u9A6C\u76F8\u8C61\u4ED5\u58EB\u5E05\u5C06\u70AE\u3000\u3000\u3000\u3000\u3000\u3000\u3000\u5175\u5352\u4E00\uFF11\u4E8C\uFF12\u4E09\uFF13\u56DB\uFF14\u4E94\uFF15\u516D\uFF16\u4E03\uFF17\u516B\uFF18\u4E5D\uFF19\u524D\u4E2D\u540E\u8FDB\u9000\u5E73';
//var ben='\uFF32\uFF28\uFF25\uFF25\uFF21\uFF21\uFF2B\uFF2B\uFF23\u3000\u3000\u3000\u3000\u3000\u3000\u3000\uFF30\uFF30\uFF11\uFF11\uFF12\uFF12\uFF13\uFF13\uFF14\uFF14\uFF15\uFF15\uFF16\uFF16\uFF17\uFF17\uFF18\uFF18\uFF19\uFF19\uFF0B\uFF1D\uFF0D\uFF0B\uFF0D\uFF1D';
var ben='\uFF32\uFF28\uFF25\uFF25\uFF21\uFF21\uFF2B\uFF2B\uFF23\u3000\u3000\u3000\u3000\u3000\u3000\u3000\uFF30\uFF30\uFF11\uFF11\uFF12\uFF12\uFF13\uFF13\uFF14\uFF14\uFF15\uFF15\uFF16\uFF16\uFF17\uFF17\uFF18\uFF18\uFF19\uFF19\uFF0B\uFF1D\uFF0D\uFF0B\uFF0D\u002E';
//var bvi='\uFF38\uFF2D\uFF34\uFF34\uFF33\uFF33\uFF2B\uFF2B\uFF30\u3000\u3000\u3000\u3000\u3000\u3000\u3000\uFF22\uFF22\uFF11\uFF11\uFF12\uFF12\uFF13\uFF13\uFF14\uFF14\uFF15\uFF15\uFF16\uFF16\uFF17\uFF17\uFF18\uFF18\uFF19\uFF19\uFF0B\uFF1D\uFF0D\uFF0B\uFF0D\uFF1D';
//var bvi1='\uFF38\uFF2D\u0056\u0056\uFF33\uFF33\uFF34\uFF34\uFF30\u3000\u3000\u3000\u3000\u3000\u3000\u3000\uFF22\uFF22\uFF11\uFF11\uFF12\uFF12\uFF13\uFF13\uFF14\uFF14\uFF15\uFF15\uFF16\uFF16\uFF17\uFF17\uFF18\uFF18\uFF19\uFF19\uFF0B\uFF1D\uFF0D\uFF0B\uFF0D\u002E';
var bvi='\uFF38\uFF2D\uFF34\uFF34\uFF33\uFF33\uFF2B\uFF2B\uFF30\u3000\u3000\u3000\u3000\u3000\u3000\u3000\uFF22\uFF22\uFF11\uFF11\uFF12\uFF12\uFF13\uFF13\uFF14\uFF14\uFF15\uFF15\uFF16\uFF16\uFF17\uFF17\uFF18\uFF18\uFF19\uFF19\uFF0B\uFF1D\uFF0D\uFF0B\uFF0D\uFF1D';
var bja='\u329F\u329A\u32A1\u32AA\u3293\u328F\u329E\u3295\u329C\u3000\u3000\u3000\u3000\u3000\u3000\u3000\u329B\u3285\uFF11\uFF11\uFF12\uFF12\uFF13\uFF13\uFF14\uFF14\uFF15\uFF15\uFF16\uFF16\uFF17\uFF17\uFF18\uFF18\uFF19\uFF19\uFF0B\uFF1D\uFF0D\uFF0B\uFF0D\uFF1D';
...
if (!DhtmlXQimgpath) var DhtmlXQimgpath='';if (!ads_dpxq) var ads_dpxq='';if (!isMXQ) var isMXQ=false;if (!ads_board) var ads_board='';
...
var NS=getBrowser();
var WIN=getWinVer();
var ZHCN=(navigator.systemLanguage||navigator.language).toLowerCase()==0;
...
lh=parseInt(16*fdbs);//Do cao dong (line-height
w0=parseInt(500*fdbs);//Chieu Rong
if (w0%2==1) w0--;
h0=Math.round(w0*7/10);//Chieu cao = 7/10 chieu rong
p0=parseInt(4*fdbs);//Border
hm=parseInt(h0/3);//Variation panel
...
var bgColor='#0B9CF5',bdColor='#666',blColor='#9DF',brColor='#FFF',qbColor='#666',qpColor='#F5D2B4',qgColor='#666',bxColor='#FFF',bsColor='#316ac5';
...
S+=('* {font-size:'+fz+'px;line-height:'+lh+'px;margin:0;padding:0;'+((!isBIG5)?'font-family:Roboto;':'font-family:Roboto;')+'}');
...
S+=('</style>');
document.write(S+'<div id="message" style="position:absolute;left:'+(wm/10)+'px;top:'+hm+'px;width:'+(wm*0.8)+'px;border:2px solid #0f0;background-color:#f4fcf3;"><div style="margin:2px;color:#00f;text-align:center;height:'+(hm-lh-lh)+'px;width:'+(wm*0.8-4)+'px;overflow:hidden;" id="messdiv">DongPing DhtmlXQ ChessBoard Loading ......</div><div style="margin-bottom:'+(fz/2)+'px;text-align:center;width:100%;"><button style="width:'+(fz*5)+'px;padding-top:2px;margin-right:20%;" onclick="clickYES()">Yes</button><button style="width:'+(fz*5)+'px;padding-top:2px;" onclick="clickNO()">No</button></div></div><div id="divs" style="overflow:hidden;"></div><div id="divsave" style="display:none;overflow:auto;"></div>');
...
function getInfo()
{
	...
	s+='Version:'+PVer+'\n';
	s+='Image:'+(VIMG?'Bitmap':'Text')+'\n';
	s+='Zoom:'+FDBS+' '+(wTitle==350?'Large':(wTitle==240?'Small':''))+'\n';
	...
	s+='Height:'+h+'px\n';
	s+='Font-size:'+fz+'px\n';
	s+='Cell width:'+qgdx+'px\n';
	s+='Piece size:'+qzdx+'px '+(imgQiZi?(qznum+'\u56FE\u5F62'):baseQiZi?'dataURL':UWD?'WebDings':'\u5B8B\u4F53')+'\u68CB\u5B50\n';
	s+='System:'+(WIN.w95?'Win95':WIN.w9x?'Win9X':WIN.w2000?'Win2000':WIN.wxp?'WinXP+':'other')+'\n';
	s+='Language:'+(ZHCN?'':'\u975E')+'\u7B80\u4F53\u4E2D\u6587\n';
	s+='Browser:'+(NS.IE?('IE '+NS.IE):NS.Firefox?('Firefox '+NS.Firefox):NS.Chrome?('Chrome '+NS.Chrome):NS.Safari?('Safari '+NS.Safari):NS.Opera?('Opera '+NS.Opera):NS.WebKit?('WebKit '+NS.WebKit):NS.Gecko?('Gecko '+NS.Gecko):'other')+'\n';
	s+='Image path:'+(DhtmlXQimgpath==''?'\u540CHTML\u6587\u4EF6':DhtmlXQimgpath)+'\n';
	if (imgQiZi)
	{
		...
		if (VIMG)
		{
			...
			s+='Comment:'+CPIMG.split('(')[1].split(')')[0]+'\n';
...
function getIMG()
{
	...
	else BGIMG='background-image:url('+IMGPATH+CNTW+'bg_00.png);';
	if (P[1]!='') CPIMG='background-image:url('+P[1]+');';
	else CPIMG='background-image:url('+IMGPATH+CNTW+'cp_00.png);';
	if (P[2]!='') BDIMG='background-image:url('+P[2]+');'+qpbdxy;
	else BDIMG='background:url('+IMGPATH+CNTW+'bd_'+qgdx+'.png) no-repeat center center;'+qpbdxy;
	if (P[3]!='') LNIMG='background-image:url('+P[3]+');'+qplnxy;
	else LNIMG='background-image:url('+IMGPATH+CNTW+'ln_'+qgdx+'.png);'+qplnxy;
	if (P[4]!='') CLIMG='background-image:url('+P[4]+');'+qpclxy;
	else CLIMG='background-image:url('+IMGPATH+CNTW+'cl_'+qgdx+'.png);'+qpclxy;
	...
	if (qznum==7)
	{
		for (i=5;i<19;i++)
		{
			...
			else QZIMG[i-(i<12?4:1)]=IMGPATH+CNTW+(i<12?('r'+(i-4)):('b'+(i-11)))+'_'+qzdx+'.png';
		}
	}
	else if (qznum==2)
	{
		...
		if (P[5]!='') QZIMG[0]=P[5];
		else QZIMG[0]=IMGPATH+CNTW+'r8_'+j+'.png';
		if (P[6]!='') QZIMG[1]=P[6];
		else QZIMG[1]=IMGPATH+CNTW+'b8_'+j+'.png';
		if (P[7]!='') QZIMG[2]=P[7];
		else QZIMG[2]=IMGPATH+CNTW+'r0_'+qgdx+'.png';
		if (P[8]!='') QZIMG[3]=P[8];
		else QZIMG[3]=IMGPATH+CNTW+'b0_'+qgdx+'.png';
	}
	else
	{
		if (P[5]!='') QZIMG[0]=P[5];
		else QZIMG[0]=IMGPATH+CNTW+'rb_'+qzdx+'.png';
...
function getTXT()
{
	...
	if (imgQiZi)
	{
		if (qznum==7) {for (var i=1;i<18;i++) QZIMG[i]=IMGPATH+CNTW+(i<11?'r':'b')+i%10+'_'+qzdx+'.png';}
		else
		{
			var j=parseInt(16*fdbs);j+=j%2;
			QZIMG[0]=IMGPATH+CNTW+'r8_'+j+'.png';
			QZIMG[1]=IMGPATH+CNTW+'b8_'+j+'.png';
			QZIMG[2]=IMGPATH+CNTW+'r0_'+qgdx+'.png';
			QZIMG[3]=IMGPATH+CNTW+'b0_'+qgdx+'.png';
		}
	}
}
function getFdbs(m)
...
function initboard()
{
	...
	//s+=cDIV(1,1,bw-2,lh*13+4,0,'line-height:'+lh+'px;background-color:#fff;text-align:center;','','<div style="height:3px;font-size:3px;line-height:3px;"></div><a href="javascript:turnBoard();">Turn</a><br><a href="javascript:mirrorBoard();">Mirro</a><br><a href="javascript:EditSave()">Save</a><br><a href="javascript:getUBB();copycode(sText);">UBB</a><br><a href="javascript:getInfo();">Info</a><br><a href="javascript:Autotimer(8000)">8s</a><br><a href="javascript:Autotimer(5000)">5s</a><br><a href="javascript:Autotimer(3000)">3s</a><br><a href="javascript:Autotimer(2000)">2s</a><br><a href="javascript:Autotimer(1000)">1s</a><br><a href="javascript:Autotimer(500)">0.5s</a><br><a href="javascript:Autotimer(200)">0.2s</a><br><a href="javascript:Autotimer(100)">0.1s</a>');
	s+=cDIV(1,1,bw-2,lh*13+4,0,'line-height:'+lh+'px;background-color:#fff;text-align:center;','','<div style="height:3px;font-size:3px;line-height:3px;"></div><a href="javascript:turnBoard();">Turn</a><br><a href="javascript:mirrorBoard();">Mirro</a><br><a href="javascript:Autotimer(8000)">8s</a><br><a href="javascript:Autotimer(5000)">5s</a><br><a href="javascript:Autotimer(3000)">3s</a><br><a href="javascript:Autotimer(2000)">2s</a><br><a href="javascript:Autotimer(1000)">1s</a><br><a href="javascript:Autotimer(500)">0.5s</a><br><a href="javascript:Autotimer(200)">0.2s</a><br><a href="javascript:Autotimer(100)">0.1s</a>');
	s+=('</div></div>');
	// move
	...
	s+=('<input type="button" style="'+bs+'left:'+(bw+bsp)+'px;" value="Mirro" id="mirror_Board" onclick="mirrorBoard()">');
	//s+=('<input type="button" style="'+bs+'left:'+(2*bw+2*bsp)+'px;width:'+(w2-bw*2-2*bsp)+'px;" value="Save" onclick="EditSave()">');
	s+=('<input type="button" style="'+bs+'left:'+(2*bw+2*bsp)+'px;width:'+(w2-bw*2-2*bsp)+'px;" value="Save" onclick="">');
	s+=('</div>');
	var scw=16;
	// comm+var
	...
	s+=('</div>');
	s+=cDIV(6,thh+ch+1,w3-7,'',0,typ,'','<a href="javascript:DelMove()" title="Delete variation">Delete Move</a>');
	...
	s+=('</div>');
	//s+=('<input type="button" style="'+bs+'left:0;" value="Mini" onclick="ViewMini()">');
	s+=('<input type="button" style="'+bs+'left:0;" value="Mini" onclick="">');
	s+=('<input type="button" style="'+bs+'left:'+(bw+bsp)+'px;" value="Im/Ex" id="showsource" onclick="ViewSource()">');
	...
	s+=('<input type="button" style="'+bs+'left:'+(2*bw+2*bsp)+'px;width:'+(w3-bw*2-2*bsp)+'px;color:f00;" value="Search" id="showsearch" onclick="">');
	s+=('</div>');
	// source
	var w4=w2+w3+ps;
	...
	s+=cDIV(6,1,w4-7,'',0,typ,'','Import Export');
	...
	//s+=cDIV(6,thh+ch+1,w4-7,'',0,typ,'','<a href="javascript:copycode(sText,0)" style="color:#f00">Copy code</a> <a href="javascript:setBinit(1)">Accept pos</a> <a href="javascript:setBinit(2)" style="color:#f00">Clear board</a> <a href="javascript:setBinit(3)">Start pos</a>');
	s+=cDIV(6,thh+ch+1,w4-7,'',0,typ,'','<a href="javascript:setBinit(1)">Accept pos</a> <a href="javascript:setBinit(2)" style="color:#f00">Clear board</a> <a href="javascript:setBinit(3)">Start pos</a>');
	...
	//s+=('Export:<a href="javascript:getUBB()" Title="UBB for CCBridge">UBB</a> <a href="javascript:getFLASH(0)" style="color:#f00">FLASH</a> <a href="javascript:getHTML()">HTM</a> <a href="javascript:getJAVA()">JAVA</a> <a href="javascript:getIFRAME()">FRAME</a> <a href="javascript:TreeSet(1)" style="color:#f00">Text</a>');
	//s+=('<br>Export:<a href="javascript:getFLASH(4)" Title="Flash use Embed into forum"><span style="color:#F00">embed</span>FLASH</a> <a href="javascript:getFLASH(1)">\u641C\u72D0</a> <a href="javascript:getFLASH(2)" style="color:#F00">QQ\u7A7A\u95F4</a> <a href="javascript:getFLASH(3)">\u5E38\u89C1\u8BBA\u575B</a>');
	//s+=('<br>ExportPOS:<a href="javascript:getIMGTEXT()">Text</a> <a href="javascript:getANIGIF()">ANIGIF</a> <a href="javascript:getFENTEXT()">Text FEN</a> <a href="javascript:getXQSJTEXT()">XQSJTEXT</a>');
	s+=('<br>ExportPOS:<a href="javascript:getFENTEXT()">Text FEN</a> ');
	//s+=('<br>InportPOS:<a href="javascript:getBinit(\'xqstudio\')">XQstudio</a> <a href="javascript:getBinit(\'xqqb\')">FEN</a> <a href="javascript:getBinit(\'xqsj\')">\u4E16\u5BB6</a>');
	//s+=('<br>InportPOS:<a href="javascript:getBinit(\'xqstudio\')">XQstudio</a> <a href="javascript:getBinit(\'xqqb\')">FEN</a> <a href="javascript:getBinit(\'xqsj\')">\u4E16\u5BB6</a>');
	s+=('<br>Add Pieces:<span id="addred"><a href="javascript:addQizi(\'0_8\')" Title="Select Red Rook">\u8F66</a><a href="javascript:addQizi(\'1_7\')" Title="Select Red Horse">\u9A6C</a><a href="javascript:addQizi(\'9_10\')" Title="Select Red Cannon">\u70AE</a><a href="javascript:addQizi(\'11_12_13_14_15\')" Title="Select Red Pawn">\u5175</a><a href="javascript:addQizi(\'2_6\')" Title="Select Red Elephant">\u76F8</a><a href="javascript:addQizi(\'3_5\')" Title="Select Red Advisor">\u4ED5</a><a href="javascript:addQizi(\'4\')" Title="Select Red King">\u5E05</a></span> <a href="javascript:addQizi(\'16_24\')" Title="Select Black \u8F66">\u8F66</a><a href="javascript:addQizi(\'17_23\')" Title="Select Black \u9A6C">\u9A6C</a><a href="javascript:addQizi(\'25_26\')" Title="Select Black \u70AE">\u70AE</a><a href="javascript:addQizi(\'27_28_29_30_31\')" Title="Select Black \u5352">\u5352</a><a href="javascript:addQizi(\'18_22\')" Title="Select Black \u8C61">\u8C61</a><a href="javascript:addQizi(\'19_21\')" Title="Select Black \u58EB">\u58EB</a><a href="javascript:addQizi(\'20\')" Title="Select Black \u5C06">\u5C06</a>');
...
function HideMove()
{
	...
	$('hidemove').innerHTML=($('hidemove').innerHTML=='Show')?'Hide':'Show';
}
function DP(p,z)
{
	if (z>=0&&z<=31)
...
function ViewSource()
{
	...
	$('showsource').value=($('showsource').value=='Source'?'Im/Ex':'Source');
	hideSearch();
}
function ViewSearch()
{
...
function hideSource()
{
	...
	$('showsource').value='Im/Ex';
}
function copycode(obj,t)
{
	var m='Copy to Clipboard successful, this can be pasted into the other software (i.e CCBridge)';
...
function getpos(t)
{
	...
	{
		p[i]=$('z'+i);
		p[i]=parseInt(p[i].style.left)/qgdx+''+parseInt(p[i].style.top)/qgdx;if(p[i]-90>=10)p[i]=p[i]-10+'';}
	if (t) return p.join('');
...
function getSEARCH()
{
	...
	s+='\u3000\u3000\u68CB\u8C31\u4ED3\u5E93\uFF0C\u767E\u4E07\u68CB\u8C31\uFF0C\u662F<span style="color:#f00;">\u6781\u5F3A\u5927\u7684\u8C61\u68CB\u5F00<br>\u5C40\u5E93</span>\uFF0C\u53EF\u8F85\u52A9\u6162\u68CB\u5F00\u5C40\uFF0C\u7814\u7A76\u68CB\u8C31\u548C\u5BF9\u624B\u8D44\u6599<br>\u7CFB<span style="color:#f00;">\u7535\u8BDD13898991761 QQ:88081492 \u65FA\u65FA:hldcg</span></a>';
...
function get_arg()
{
	return ('[chessboard][DhtmlXQ_init]500,350[/DhtmlXQ_init][DhtmlXQ_binit]'+P[0]+'[/DhtmlXQ_binit]'+UBB.replace('HoiCoUp','xxx').replace(/DhtmlXQ_move_0_1_0/gi,'DhtmlXQ_movelist').replace(/DhtmlXQ_comment0_/gi,'DhtmlXQ_comment').replace(/\[(DhtmlXQ_(refer|generator|viewtype|diy\w+|hidemove|txttype|price|hidden|viewurl|liveadmin|livetext|ver|init|binit|zoom))\][\w\W]*\[\/\1\]/gi,'')+'[/chessboard]').replace(/[\r\n]+/gi,'').replace(/\?/gi,'\\'+'u003F').replace(/&/gi,'\\'+'u0026').replace(/\=/gi,'\\'+'u003D').replace(/\'/gi,'\\'+'u0027').replace(/\"/gi,'\\'+'u0022');
}
function copyUBB()
{
	sText.value=get_arg();
...
function getFLASH(t)
{
	...
	var s2='\u4E0A\u53D1\u5E03FLASH\u52A8\u6001\u68CB\u76D8';
	var s1='\r\n\u3000\u3000\u5E38\u89C1\u8C61\u68CB\u7F51\u7AD9\u90FD\u5DF2\u5B89\u88C5DhtmlXQ\u52A8\u6001\u68CB\u76D8Hide\u652F\u6301\uFF0C\u8BF7\u60A8\u5BFC\u51FAUBB\u4EE3\u7801\u53D1\u8868\u68CB\u8C31\r\n\r\n';
...
function getTEXT(v)
{
	...
	else
	{
		...
		if (temp!=null)
		{
			...
			if (v==1) showalert('\u672C\u68CB\u8C31['+getvar('title')+']\u5171\u542B'+result.length+'\u4E2A\u53D8\u7740\uFF0C\u672C\u6B21\u5BFC\u51FA'+i+'\u4E2A['+tnum+'\u5C42]\u53D8\u7740'+((result.length>i)?('\uFF0C\u8FD8\u6709'+(result.length-i)+'\u4E2A\u53D8\u7740\u672A\u80FD\u5BFC\u51FA'):''));
		}
		else tree='';
...
function getBinit(t)
{
	...
	{
		showalert('\u60A8\u7684\u6D4F\u89C8\u5668\u4E0D\u652F\u6301\u4ECE\u526A\u8D34\u677F\u4E2D\u7C98\u8D34\u6570\u636E\uFF0C\u56E0\u6B64\u65E0\u6CD5\u4F7F\u7528\u672C\u529F\u80FD');
		return;
	}
...
function EditComment(comm)
{
	if (isAddMove) 
	{
		showalert('Has quit [Add Variation] states');
		$('e_comm').innerHTML='EditCom';
		isAddMove=false;
		ShowCommentText();
		return;
	}
...
function getrefer()
{
	...
	var s='<div style="position:absolute;right:0;top:0;text-align:right;width:'+(fz*19+6)+';"><a href="javascript:copysurl()">Copy</a>'+((isSP)?' <a href="javascript:digg(1)">\u597D\u8BC4</a> <a href="javascript:digg(-1)">\u5DEE\u8BC4</a> <a href="javascript:digg(0)">\u62A5\u9519</a> <a href="javascript:gEvent()">\u8D5B\u4E8B</a> <a href="javascript:SearchP(\'tree\')">\u53D8\u7740</a> <a href="javascript:SearchP(\'next\')">\u5BF9\u5C40</a>':'')+'</div>';
...
function c_move(m)
{	
	MNot=getvar('movenotation');
	if (!MNot) MNot='en';
	var b=(MNot=='en'?ben:(MNot=='vi'?bvi:(MNot=='ja'?bja:bch)));
...
function TXTtoDhtmlXQ(obj)
{
	...
	if (m==null)
	{
		showalert('While done, click on [Black]');
		obj.value=s2+s1+'\r\n';isAddMove=true;
	}
	else
	{
